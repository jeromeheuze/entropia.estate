    ...
    <main>
      ...
      <div class="container siteContent subPages">
        <div class="breadcrumbs">
          ...
          <nuxt-link to="/deeds-condos-shops-estates-2024/">Estate Deeds 2024</nuxt-link>  <em class="bc-next"></em>
          <nuxt-link to="/deeds-condos-shops-estates-2024/">Estate Deeds 2024</nuxt-link>
        </div>
        <h1>Estate Deeds 2024</h1>
    ...
    async fetchPlanet(planet) {
      ...
      if (planet === 'All') {
        init = await this.$supabase.from("all_estates_deed")
            .select('*')
            //.eq('planet', planet)
            .lt('date_end', '2024-12-31')
            .gt('date_end', '2024-01-01')
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Market data for 2024 of auction about Player housing in Entropia Universe. And your first stop for virtual visits of Entropia estates.'
        },
        {
          hid: 'twitter:url',
          name: 'twitter:url',
