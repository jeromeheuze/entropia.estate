              ...
              <div class="tableContainer">
                <table class="table table-borderless">
                  ...
                  <tr style="color: aliceblue;" v-for='estate in estates' :key="estate.id">
                    ...
                    <td><nuxt-link :to="estate.planet | planet">{{ estate.planet }}</nuxt-link></td>
    ...
    async fetchPlanet(planet) {
      ...
      if (planet === 'All') {
        init = await this.$supabase.from("all_estates_deed")
            .select('*')
            //.eq('planet', planet)
            .lt('date_end', '2023-12-31')
            .gt('date_end', '2023-01-01')
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Market data for 2023 of auction about Player housing in Entropia Universe. And your first stop for virtual visits of Entropia estates.'
        },
        {
          hid: 'twitter:url',
          name: 'twitter:url',
